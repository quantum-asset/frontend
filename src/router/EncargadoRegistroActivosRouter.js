...
const EncargadoRegistroActivosRouter = (props) => {
  ...
  console.log("EncargadoRegistroActivos:", props);
  return (
    <Fragment>
      <SideBar {...props}>
      ...
      >
        ...
        <Route
          exact
          path="/encargado-registro-activos/registro-activos"
          component={(props) => <Maestros {...props} />}
        />
      </DefaultMainPage>
...
export default EncargadoRegistroActivosRouter;
